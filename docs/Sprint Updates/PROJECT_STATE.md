...
Select the next optimization from remaining benchmark evidence. Historical mechanism truth, direct recommendation evidence grounding, and reduced-capacity risk-language scoring remain measured candidates. Mechanism merge, split, retirement, reactivation, supersession, and full lineage remain deferred pending a dedicated benchmark-led sprint.
...
Current through Sprint 102 intervention-risk preservation.
