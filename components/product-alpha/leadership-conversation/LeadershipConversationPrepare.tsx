...
export function LeadershipConversationPrepare({ prepare, valueLayer, initialMeetingPack=null, meetingPackUnavailable=false, onProgressiveDisclosure,onPackChange,seriesAddress,editable=true }: { prepare: ExecutivePrepareViewV1; valueLayer?: ChiefOfStaffValueLayerV1; initialMeetingPack?:ChiefMeetingPackViewV1|null; meetingPackUnavailable?:boolean; onProgressiveDisclosure?:(category:"questions-tensions"|"reasoning-provenance")=>void;onPackChange?:(exists:boolean,stale:boolean)=>void;seriesAddress?:string;editable?:boolean }) {
