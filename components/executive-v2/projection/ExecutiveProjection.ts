...
export type ExecutiveProjection = {
   ...
   *
   * Preserved independently because explanation remains a
   * reusable cognitive object.
   */
  executiveExplanation?: ExecutiveExplanation;

  /**
   * Canonical board-ready executive communication generated by
   * CAP-COM-001 — Executive Communication Synthesis.
   *
   * This is the final executive communication artifact consumed
   * by the Executive Workspace.
   *
   * It includes:
   *
   * • concise executive story
   * • recommendation
   * • confidence
   * • supporting signals
   ...
   * • evidence sections
   *
   * Projection consumes this object directly rather than
   * reconstructing communication from cognitive objects.
   */
