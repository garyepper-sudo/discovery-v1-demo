...
const required=["DISCOVERY_CHIEF_COMPOSITION","DISCOVERY_RUNTIME_STORAGE_BACKEND","DISCOVERY_EXECUTIVE_HISTORY_ACCESS_STORAGE_BACKEND","DISCOVERY_CHIEF_BLOB_PREFIX","DISCOVERY_PARTICIPANT_IDENTITY_LOCATOR_KEY","CLERK_SECRET_KEY","NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY","OPENAI_API_KEY","BLOB_READ_WRITE_TOKEN","CRON_SECRET"] as const;
