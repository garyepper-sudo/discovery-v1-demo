...
export function validateProductArtifactBodyRefV1(value: ProductArtifactBodyRefV1): void {
  ...
  const types: readonly string[] = ["prepared-work", "frozen-snapshot", "private-working-contribution", "meeting-pack-private-note", "meeting-pack-draft", "source-scoped-analysis", "what-changed", "product-decision-draft"];
  if (
