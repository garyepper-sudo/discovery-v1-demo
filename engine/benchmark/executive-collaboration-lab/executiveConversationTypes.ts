...
export type ConversationTraceTurn = { turn: number; executiveMessage: string; action?: ConversationAction; discoveryResponse: string; questionCount: number; recognizedConcepts: string[]; challenged: boolean; recommendationPresent: boolean; durableWrites: ConversationAction[] };
