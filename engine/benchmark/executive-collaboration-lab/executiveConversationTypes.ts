...
import type { ExecutiveConversationInterpretation, ProviderConversationObservation } from "../../conversation";
...
export type CollaborationDimension = "executiveUnderstanding" | "questionQuality" | "collaborativeReasoning" | "challengeOpportunityDetection" | "challengeQuality" | "conversationalContinuity" | "modelStewardship" | "recommendationQuality" | "actionHandoff" | "sessionImpactAccuracy" | "executiveTrust";
export type ConversationTraceTurn = { turn: number; executiveMessage: string; action?: ConversationAction; interpretation: ExecutiveConversationInterpretation | null; providerObservation: ProviderConversationObservation | null; discoveryResponse: string; questionCount: number; recognizedConcepts: string[]; challenged: boolean; recommendationPresent: boolean; durableWrites: ConversationAction[] };
