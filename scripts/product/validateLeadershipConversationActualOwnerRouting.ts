...
async function main(): Promise<void> {
  ...
  check(replay.includes("beginReviewedCarryForward") && replay.includes("decision-draft") && replay.includes("assumption-change") && replay.includes("follow-up-question"), "replay additionally admits the deterministic five-kind Reviewed Carry-Forward candidate through the actual boundary");
  check(replay.includes("ensureReviewedCarryForwardRoute") && replay.includes("completeReviewedCarryForward") && replay.includes("reviewed-carry-forward-completion"), "replay additionally routes terminal reviewed material and creates its durable completion through actual owners");
  check(replay.includes("closure-rejects-before-completion") && replay.includes("prepare-again-rejects-before-what-changed") && replay.includes("what-changed-exact-replay"), "replay additionally enforces the stronger closure and What Changed prerequisites");
