...
async function validateCanonicalServerCurrentAccess(): Promise<number> {
  ...
  try {
    ...
    const foreignConversationId="conversation:foreign-canonical-owner-partition",foreignWorkspace=structuredClone(readLeadershipConversationFixture().base);foreignWorkspace.organizationId=foreignOrganizationId;foreignWorkspace.questionId=foreignQuestionId;
